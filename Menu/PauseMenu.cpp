...
void PauseMenu::Init(void)
{
    ...
    this->_option = std::make_unique<Button>(this->_ctrl->_device, vector2d<int>(400, 100), vector2d<int>(WIDTH/ 2 - 200, HEIGHT / 2), GUI_ID_OPTION_BUTTON_PAUSED, "../assets/pause/settings_pause.jpg", "../assets/pause/settings_pause_fonce.jpg");
