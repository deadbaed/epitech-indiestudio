...
{
    this->_background = this->_ctrl->_driver->getTexture(("../assets/menu/fd_select.jpg"));
    ...
    this->_third_skin_one = std::make_unique<Button>(this->_ctrl->_device, vector2d<int>(70, 70), vector2d<int>((WIDTH / 4) + 5, HEIGHT - 110), GUI_ID_SKIN_BLACK_BUTTON, "../assets/menu/black.png", "../assets/menu/black.png");
    ...
    this->_third_skin_two = std::make_unique<Button>(this->_ctrl->_device, vector2d<int>(70, 70), vector2d<int>(WIDTH - (WIDTH / 4) + 5, HEIGHT - 110), GUI_ID_SKINS_BLACK_BUTTON, "../assets/menu/black.png", "../assets/menu/black.png");
    ...
    this->_buttonGo = std::make_unique<Button>(this->_ctrl->_device, vector2d<int>(150, 150), vector2d<int>((WIDTH / 2) - 75, HEIGHT - 160), GUI_ID_GO_BUTTON, "../assets/menu/go.png", "../assets/menu/go_fonce.png");
    this->_buttonBack = std::make_unique<Button>(this->_ctrl->_device, vector2d<int>(150, 150), vector2d<int>((WIDTH / 2) - 550, (HEIGHT / 2) - 300), GUI_ID_PLAY_BUTTON, "../assets/menu/fleche.png", "../assets/menu/fleche_fonce.png");
