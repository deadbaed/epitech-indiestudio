...
void SelectSkins::Init(void)
{
    ...
    this->_first_skin_one = std::make_unique<Button>(this->_ctrl->_device, vector2d<int>(70, 70), vector2d<int>((WIDTH / 4) - 75, HEIGHT - 110), GUI_ID_SKIN_WHITE_BUTTON, FIRST_SKIN_SSS, FIRST_SKIN_SSS);
    this->_second_skin_one = std::make_unique<Button>(this->_ctrl->_device, vector2d<int>(70, 70), vector2d<int>((WIDTH / 4) - 155, HEIGHT - 110), GUI_ID_SKIN_BLUE_BUTTON, SECOND_SKIN_SSS, SECOND_SKIN_SSS);
    this->_third_skin_one = std::make_unique<Button>(this->_ctrl->_device, vector2d<int>(70, 70), vector2d<int>((WIDTH / 4) + 5, HEIGHT - 110), GUI_ID_SKIN_BLACK_BUTTON, THIRD_SKIN_SSS, THIRD_SKIN_SSS);
    this->_fourth_skin_one = std::make_unique<Button>(this->_ctrl->_device, vector2d<int>(70, 70), vector2d<int>((WIDTH / 4) + 85, HEIGHT - 110), GUI_ID_SKIN_GREEN_BUTTON, FOURTH_SKIN_SSS, FOURTH_SKIN_SSS);
    ...
    this->_second_skin_two = std::make_unique<Button>(this->_ctrl->_device, vector2d<int>(70, 70), vector2d<int>(WIDTH - (WIDTH / 4) - 155, HEIGHT - 110), GUI_ID_SKINS_BLUE_BUTTON, SECOND_SKIN_SSS, SECOND_SKIN_SSS);
    this->_third_skin_two = std::make_unique<Button>(this->_ctrl->_device, vector2d<int>(70, 70), vector2d<int>(WIDTH - (WIDTH / 4) + 5, HEIGHT - 110), GUI_ID_SKINS_BLACK_BUTTON, THIRD_SKIN_SSS, THIRD_SKIN_SSS);
    this->_fourth_skin_two = std::make_unique<Button>(this->_ctrl->_device, vector2d<int>(70, 70), vector2d<int>(WIDTH - (WIDTH / 4) + 85, HEIGHT - 110), GUI_ID_SKINS_GREEN_BUTTON, FOURTH_SKIN_SSS, FOURTH_SKIN_SSS);
